      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            I am from Pakistan and currently living in Karachi. 
            I am doing Bachelor's in Software Engineering and working as a UI/UX designer.
          </p>
        </div>
          ...
          {skills.map((skill) => (
            ...
            >
              <img
                src={skill.icon}
                alt={skill.name}
                className="w-16 h-16 mb-4 drop-shadow-[0_0_15px_#00ffff]"
              />
