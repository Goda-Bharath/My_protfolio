    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-22 right-7 z-[100] h-14 w-14 bg-[#25D366] rounded-full shadow-2xl hover:scale-110 transition-all duration-300 border-4 border-white flex items-center justify-center active:scale-95"
                aria-label="Open WhatsApp Chat"
            >
                <svg className="w-8 h-8" viewBox="0 0 24 25" fill="#0eff36">
            ...
            <a
                ...
                className="fixed bottom-6 right-7 z-[1000] h-12 w-12 flex items-center justify-center rounded-full bg-[#0A66C2] shadow-2xl hover:scale-110 transition-all duration-300 border-4 border-white active:scale-95"
            ...
            {open && (
                <div className="fixed bottom-32 right-6 w-80 bg-white rounded-2xl shadow-2xl z-[1001] border border-gray-200 animate-in slide-in-from-bottom-2 duration-300 max-h-[500px]">
                    {/* Header */}
