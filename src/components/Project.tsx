      ...
      <section id="githubactivity" className="py-16 bg-black text-white">
        ...
        <div className="flex justify-center">
          <img
            ...
            className="rounded-xl shadow-2xl border border-gray-700 w-300 h-60"
          />
        </div>

        <p className="text-center text-white mt-6 max-w-2xl mx-auto">
          Consistent contributions in web development and backend projects.
          I regularly push improvements, feature updates, and learning experiments.
        </p>
      </section>
